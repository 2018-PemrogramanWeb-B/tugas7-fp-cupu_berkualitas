        ...
        <div class="row">
          <div class="col-12">
            <div class="section-title-header text-center">
              <h1 class="section-title wow fadeInUp" data-wow-delay="0.2s">How To Donate</h1>
            </div>
          </div>
        </div>
                ...
                <div id="accordion">
                  ...
                  <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                      <div class="card-body">
                        <p>You will recieve transfer code in your email </p>
                        <div class="location">
                          <span>F-Share Code:</span> 563723
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="card">
                    ...
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                      <div class="card-body">
                        <p>Masukkan charity code dan kode transfer melalui atm/teller dan kalian akan berhasil berdonasi</p>
                      </div>
